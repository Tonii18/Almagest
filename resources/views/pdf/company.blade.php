...
<body>
    <table>
        ...
        <tr>
            <td rowspan="6"><img src="{{ public_path('img/logo.png') }}" alt="Logo de la empresa" style="width:25px;"></td>
            <td>Nombre</td>
        ...
        <tr>
            ...
            <td>{{ optional($company->contactPerson->first())->firstname ?? '' }}
                {{ optional($company->contactPerson->first())->secondname ?? '' }}</td>
            <td>Cargo</td>
            <td>Gerente</td>
        </tr>
        <tr>
